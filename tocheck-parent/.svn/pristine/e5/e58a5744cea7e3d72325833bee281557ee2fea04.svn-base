...
<head>
    ...
    <title>订单结算(流量费)</title>
</head>
<body>
<!-- Main bar -->
<div class="mainbar">
    <div class="page-head">
        <h2 class="pull-left"><i class="icon-table"></i>订单结算(流量费)</h2>
                ...
                <div class="col-md-12">
                    <div class="widget" style="margin-top: 0px;">
                            <div class="widget-head">
                                ...
                                <a class="btn btn-success" href="javascript:void(0);" action="ajax-confirm-delete" tip="确定要全部提现吗?" url="flowWithdraw.ajax">申请提现</a>
                                <div class="clearfix"></div>
                            </div>
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <c:forEach items="${page.getList()}" var="r">
                                    <tr align="center">
                                        ...
                                        <td>${r.flowFee}</td>
                                        <td>
                                            <c:if test="${r.settlementStatus == 1 || r.settlementStatus == 3}">
                                                待结算
                                            </c:if>
                                            <c:if test="${r.settlementStatus == 5 || r.settlementStatus ==7}">
                                                已结算
                                            </c:if>
                                        </td>
                                        </tr>
