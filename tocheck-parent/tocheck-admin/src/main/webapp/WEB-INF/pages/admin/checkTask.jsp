                                    ...
                                    <tr align="center">
                                        ...
                                        <td>
                                            <c:if test="${r.status ==0 || r.status ==2}">
                                                <a  class="btn btn-danger" action='ajax-confirm-delete' tip='确定要放入抢单池?' url="putRushOrder.ajax?id=${r.id}">放入抢单池</a>
                                            </c:if>
...
<script src="${__base}/resources/js/admin/checkTask.js"></script>
</body>
</html>
